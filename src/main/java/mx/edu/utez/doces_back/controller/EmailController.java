...
public class EmailController {
    ...
    public ResponseEntity<ApiResponse> senderEmail(
    ...
    public ResponseEntity<ResponseEntity<Object>> sendSimpleEmail(
        ...
        try {
            ...
            return new ResponseEntity<>(Utilities.generateResponse(INTERNAL_SERVER_ERROR, String.valueOf(INTERNAL_SERVER_ERROR)), INTERNAL_SERVER_ERROR);
        }
    }
